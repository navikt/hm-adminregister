        ...
        <Tabs.Panel value="videos" className={styles.tabPanel}>
            <VStack gap="8">
                ...
                <Alert variant="warning">
                    Sørg for at videoen som lenkes til er tekstet, har synstolking og at kravene til universell
                    utforming følges.
                    De som ikke kan høre lyd skal for eksempel få presentert lydinnholdet på en alternativ måte. Dette
                    er
                    lovpålagt.
                    <Link href="https://www.uutilsynet.no/wcag-standarden/12-tidsbaserte-medier/743">
                        Ytterligere informasjon om teksting av videoer finnes på nettsidene til Tilsynet for universell
                        utforming av
                        ikt
                    </Link>
                </Alert>
