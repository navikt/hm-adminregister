 ...
 */
export function createDescendantContext<T extends HTMLElement = HTMLElement, K extends Record<string, any> = object>() {
  const [DescendantsContextProvider, useDescendantsContext] = createContext<ReturnType<typeof _useDescendants>>({
    name: "DescendantsProvider",
    errorMessage: "useDescendantsContext must be used within DescendantsProvider",
  });

  const ContextProvider = cast<React.Provider<DescendantsManager<T, K>>>((props) => (
    <DescendantsContextProvider {...props.value}>{props.children}</DescendantsContextProvider>
  ));
