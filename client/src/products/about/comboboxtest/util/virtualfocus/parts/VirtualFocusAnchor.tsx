...
import { useVirtualFocusDescendant, useVirtualFocusInternalContext } from "../Context";
 ...
 */
export const VirtualFocusAnchor = forwardRef<HTMLInputElement, VirtualFocusAnchorProps>(
