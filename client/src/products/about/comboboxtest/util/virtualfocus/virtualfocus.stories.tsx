...
import React, { Dispatch, ReactNode, SetStateAction, forwardRef, useRef, useState } from "react";
import { CloudIcon, HangerIcon, HourglassIcon, HouseIcon, PuzzlePieceIcon, RulerIcon } from "@navikt/aksel-icons";
