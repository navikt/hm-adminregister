import { AgreementPostDTO, ProduktvarianterForDelkontrakterDTOList } from '../../utils/response-types'
...
interface DelkontraktProps {
  delkontrakt: AgreementPostDTO;
  produkter: ProduktvarianterForDelkontrakterDTOList
}


export const Delkontrakt = ({ delkontrakt, produkter }: DelkontraktProps) => {
                  ...
                  {produkter.map((produkt, i) => {
                    return (
                      <Table.Row key={i} shadeOnHover={false}>
                        ...
                        <Table.DataCell>{produkt.produktvarianter.length}</Table.DataCell>
