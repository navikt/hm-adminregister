import {Alert, BodyShort, Box, Button, CopyButton, ExpansionCard, Heading, HStack, Loader, VStack} from "@navikt/ds-react";
import {useEffect, useState} from "react";
import {baseUrl} from "utils/swr-hooks";
import {importKatalogfil} from "api/ImportExportApi";
import {
    CatalogImport, DuplicateConflict
                    ...
                    <div className="content">
                        ...
                        <VStack gap="space-8">
                            ...
                            {(insertedList.length > 0 ||
                                ...
                                <BodyShort size="medium">
                                    Importeringen var vellykket. Etter noen minutter, blir de nye tilknytningene
                                    tilgjengelig på{" "}
                                    {insertedList.length > 0 ? (
                                        ...
                                        <VStack gap="space-8">
                                            ...
                                            <Box background="default" padding="space-8">
                                                ...
                                                {duplicateConflicts.map((conflict, index) => (
                                                    <VStack>
                                                        <BodyShort>LevArtNr: <b>{conflict.supplierRef}</b> finnes
                                                            allerede for denne leverandøren.</BodyShort>
                                                        <BodyShort>
                                                            Importert produkt som fører til problem har
                                                            hmsArtNr: {conflict.hmsArtNr} og
                                                            levArtNr: {conflict.supplierRef}
                                                        </BodyShort>
                                                        <BodyShort>
                                                            Eksisterende produkt som fører til problem har
                                                            hmsArtNr: {conflict.conflictingHmsArtNr} og
                                                            levArtNr: {conflict.supplierRef}
                                                        </BodyShort>
                                                    </VStack>
                                                ))}
