...
const NewCompatiblePartsOnSeries = ({ modalIsOpen, setModalIsOpen, mutateParts, seriesId }: Props) => {
  ...
  async function onClickLeggTilKobling() {
    ...
    if (productsToAdd.length > 0) {
      addCompatibleWithSeriesForParts(
        seriesId,
...
export default NewCompatiblePartsOnSeries;
