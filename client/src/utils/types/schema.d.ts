...
export interface paths {
    ...
    "/admreg/admin/api/v1/product/registrations/tech-data/bulk": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put: operations["bulkUpdateTechData"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/admreg/admin/api/v1/techlabel/registrations/section": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/admreg/admin/api/v22/isocategory": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations["getAllIsos"];
        put?: never;
        post: operations["createIso"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/admreg/admin/api/v22/isocategory/{isocode}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put: operations["updateIsoByIsocode"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/admreg/admin/api/v22/isomap": {
        ...
        get: operations["getAllIsoMaps"];
        put?: never;
        post: operations["createIsoMap"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/admreg/admin/api/v22/isomap/{id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/admreg/api/v1/techlabels/all/sections": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/admreg/api/v22/isocategories": {
        ...
        get: operations["getAllCategories_2"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/admreg/api/v22/isocategories/{isocode}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations["getCategoryByIsocode_2"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/admreg/internal/iso22-util/check-mapping": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations["checkIsoMapping"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/admreg/internal/iso22-util/rebuild-iso22-tree": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        post: operations["rebuildIso22Tree"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/admreg/internal/iso22-util/rebuild-nat-mapping": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        post: operations["updateIsoNatMapping"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/admreg/internal/iso22-util/upload": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/admreg/internal/iso22-util/upload-mapping": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        post: operations["updateIsoMapping"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        BulkTechDataUpdateDTO: {
            updates: components["schemas"]["VariantTechDataUpdate"][];
        };
        BulkTechDataUpdateError: {
            /** Format: uuid */
            productId: string;
            message: string;
        };
        BulkTechDataUpdateResultDTO: {
            updated: components["schemas"]["ProductRegistrationDTOV2"][];
            failed: components["schemas"]["BulkTechDataUpdateError"][];
        };
        CatalogFile: {
            /** Format: uuid */
            id: string;
        ...
        Iso22: {
            ...
            searchWords: string[];
            isoType: components["schemas"]["IsoType"];
            createdByUser: string;
            updatedByUser: string;
            createdBy: string;
            updatedBy: string;
        ...
        IsoMap: {
            ...
            id: string;
            code16?: string | null;
            mapEnum: components["schemas"]["IsoMapEnum"][];
            code22?: string | null;
            /** Format: date-time */
            created: string;
            verified: boolean;
        ...
        /** @enum {string} */
        IsoMapEnum: "SAME" | "CHANGED_CODE_SAME_HEADER" | "CHANGED_CODE_CHANGED_HEADER" | "SAME_CODE_CHANGED_HEADER" | "NEW_CODE_NEW_HEADER_MERGED" | "SAME_OR_CHANGED_CODE_SAME_HEADER_MERGED" | "CHANGED_EXPLANATION" | "ADDED_EXPLANATION" | "NEW_CODE_NEW_HEADER_SPLIT" | "NEW_CODE_SAME_HEADER_SPLIT" | "DELETED_CLASS_OR_SUBCLASS_OR_SECTION" | "NEW_CLASS_OR_SUBCLASS_OR_SECTION" | "SAME_CODE_NEW_HEADER_AND_EXPLANATION" | "UNKNOWN";
        IsoTranslations: {
            titleEn?: string | null;
            textEn?: string | null;
        };
        ...
        /** @enum {string} */
        MediaSourceType: "HMDB" | "REGISTER" | "EXTERNALURL" | "IMPORT" | "NEWS" | "UNKNOWN";
        /** @enum {string} */
        ...
        SeriesDTO: {
            ...
            isoCategory22?: components["schemas"]["IsoCategory22DTO"] | null;
            message?: string | null;
            ...
            isPublished: boolean;
            inAgreement: boolean;
            agreements: components["schemas"]["SeriesAgreementInfo"][];
            hmdbId?: string | null;
        };
        SeriesDataDTO: {
            media: components["schemas"]["MediaInfoDTO"][];
...
export interface operations {
    ...
    bulkUpdateTechData: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["BulkTechDataUpdateDTO"];
            };
        };
        responses: {
            /** @description bulkUpdateTechData 200 response */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["BulkTechDataUpdateResultDTO"];
                };
            };
        };
    };
    ...
    updateSection: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["TechLabelSectionUpdateDTO"];
            };
        };
        responses: {
            /** @description updateSection 200 response */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getAllIsos: {
        ...
        requestBody?: never;
        responses: {
            /** @description getAllIsos 200 response */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["Iso22"][];
                };
            };
        };
    };
    createIso: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Iso22DTO"];
            };
        };
        responses: {
            /** @description createIso 200 response */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    updateIsoByIsocode: {
        ...
        responses: {
            /** @description updateIsoByIsocode 200 response */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getAllIsoMaps: {
        ...
        requestBody?: never;
        responses: {
            /** @description getAllIsoMaps 200 response */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["IsoMapDTO"][];
                };
            };
        };
    };
    createIsoMap: {
        ...
        requestBody: {
            content: {
                "application/json": {
                    isoMap: components["schemas"]["IsoMapDTO"];
                };
            };
        };
        responses: {
            /** @description createIsoMap 200 response */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    updateIsoMap: {
        ...
        responses: {
            /** @description updateIsoMap 200 response */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    fetchSections: {
        ...
        requestBody?: never;
        responses: {
            /** @description fetchSections 200 response */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getAllCategories_2: {
        ...
        requestBody?: never;
        responses: {
            /** @description getAllCategories_2 200 response */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["IsoCategory22DTO"][];
                };
            };
        };
    };
    getCategoryByIsocode_2: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody?: never;
        responses: {
            /** @description getCategoryByIsocode_2 200 response */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getAllMappings: {
        ...
        requestBody?: never;
        responses: {
            /** @description getAllMappings 200 response */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    checkIsoMapping: {
        ...
        requestBody?: never;
        responses: {
            /** @description checkIsoMapping 200 response */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    rebuildIso22Tree: {
        ...
        requestBody?: never;
        responses: {
            /** @description rebuildIso22Tree 200 response */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    updateIsoNatMapping: {
        ...
        requestBody?: never;
        responses: {
            /** @description updateIsoNatMapping 200 response */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    uploadList: {
        ...
        responses: {
            /** @description uploadList 200 response */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    updateIsoMapping: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["IsoMap"][];
            };
        };
        responses: {
            /** @description updateIsoMapping 200 response */
            200: {
                headers: {
                    [name: string]: unknown;
                };
